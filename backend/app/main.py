...
app.include_router(router=chat.router, prefix='/chat', tags=['Chatbot'])
app.include_router(router=favorite.router, prefix='/favorites', tags=['Favorites'])
app.include_router(router=visited_place.router, prefix='/visited', tags=['Visited'])
app.include_router(router=itinerary.router, prefix='/itineraries', tags=['Itinerary'])
